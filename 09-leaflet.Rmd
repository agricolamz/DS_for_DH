...
```{block, type = "rmdtask"}
Существует [проект Карта ДТП](https://github.com/tadata-ru/dtp-stat), в котором собран датасет c дорожными происшествиями в России. Визуализируйте все столкновения из датасета. Что можно увидеть на получившейся карте?
```
