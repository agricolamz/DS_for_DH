...
\hypersetup{unicode=true,
            pdftitle={Наука о данных для Цифровых гуманитарных исследований в R},
            pdfauthor={Г. А. Мороз},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  ...
  \title{Наука о данных для Цифровых гуманитарных исследований в R}
...
\section{Полезные ссылки}\label{section-1}}
...
You can label chapter and section titles using after them, e.g., we can reference Chapter \ref{intro}. If you do not manually label them, there will be automatic labels anyway, e.g..
